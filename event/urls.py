...
urlpatterns = [
    ...
    path('register/', userapp_views.register, name="users-register"),
    path('login/', auth_views.LoginView.as_view(template_name="users/login.html"), name="users-login"),
    path('logout/', userapp_views.logout_user, name="users-logout"),
    path('profile/', userapp_views.user_profile, name="users-profile"),
